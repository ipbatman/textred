...
const DICT_STOP = ['вот', 'сейчас', 'от',
  'во', 'не', 'что', 'он', 'я', 'со', 'как', 'а',
  'то', 'все', 'она', 'так', 'его', 'но', 'да', 'ты', 'у', 'же',
  'вы', 'за', 'бы', 'только', 'ее', 'мне', 'было',
  'они', 'ему', 'теперь', 'когда', 'даже', 'ну', 'вдруг', 'ли',
...
const DICT_CLICHE = ['в настоящее время', 'на сегодняшний день', 'на данный момент', 'следует отметить',
  'стоит отметить', 'как уже было сказано', 'в связи с этим', 'на самом деле', 'безусловно', 'без сомнения', 'в общем и целом', 'по большому счету', 'так или иначе', 'тем не менее', 'в первую очередь', 'как таковой', 'имеет место', 'в рамках', 'в целях', 'в сфере', 'в области', 'является', 'осуществляет', 'производит'];
...
const DICT_WEAK = ['был', 'Есть', 'является', 'существовало', 'существуют', 'являются', 'являться',
  ...
  'связи', 'причине', 'факт', 'вопрос', 'уровне', 'целях', 'рамках', 'порядке', 'основе', 'обладает'
];
...
const DIST_PERSONAL = ['его', 'оно', 'ему', 'они', 'Их', 'мы', 'ее', 'он',
  'я', 'меня', 'мне', 'мной', 'ты', 'тебя', 'тебе', 'тобой', 'его', 'нему', 'ним', 'она', 'её', 'ней', 'ней', 'оно', 'нему', 'ним', 'нас', 'нам', 'нами', 'вы', 'вас', 'вам', 'вами', 'ним', 'ними', 'ими'
];
...
const DIST_GENERALIZATION = ['всю', 'все', 'всегда', 'никогда', 'никто', 'каждый', 'любой', 'абсолютно все', 'везде', 'всюду', 'нигде', 'полностью', 'целиком', 'единственный', 'без исключений', 'сплошь и рядом', 'всем известно', 'стопроцентно', 'повсеместно', 'тотально', 'вечно', 'постоянно', 'безусловно все'
];
